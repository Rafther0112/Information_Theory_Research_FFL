...
axes[0, 0].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_C[regulacion_K][0]) + np.array(proteinas_estado_estacionario_Z_C[regulacion_K][0]), linestyle = "--", color = Red_color)
axes[0, 0].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_C[regulacion_K][1]) + np.array(proteinas_estado_estacionario_Z_C[regulacion_K][1]), linestyle = "--", color = Orange_color)
axes[0, 0].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_C[regulacion_K][2]) + np.array(proteinas_estado_estacionario_Z_C[regulacion_K][2]), linestyle = "--", color = Green_color)
axes[0, 0].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_C[regulacion_K][3]) + np.array(proteinas_estado_estacionario_Z_C[regulacion_K][3]), linestyle = "--", color = Blue_color)
...
axes[0, 0].set_ylim([189000, 205000])  
...
axes[0, 1].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_C[regulacion_K][0]) + np.array(proteinas_estado_estacionario_Z_C[regulacion_K][0]), linestyle = "--", color = Red_color)
axes[0, 1].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_C[regulacion_K][1]) + np.array(proteinas_estado_estacionario_Z_C[regulacion_K][1]), linestyle = "--", color = Orange_color)
axes[0, 1].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_C[regulacion_K][2]) + np.array(proteinas_estado_estacionario_Z_C[regulacion_K][2]), linestyle = "--", color = Green_color)
axes[0, 1].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_C[regulacion_K][3]) + np.array(proteinas_estado_estacionario_Z_C[regulacion_K][3]), linestyle = "--", color = Blue_color)
...
axes[0, 1].set_ylim([189000, 205000])  
...
axes[1, 0].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_C[regulacion_K][0]) + np.array(proteinas_estado_estacionario_Z_C[regulacion_K][0]), linestyle = "--", color = Red_color)
axes[1, 0].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_C[regulacion_K][1]) + np.array(proteinas_estado_estacionario_Z_C[regulacion_K][1]), linestyle = "--", color = Orange_color)
axes[1, 0].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_C[regulacion_K][2]) + np.array(proteinas_estado_estacionario_Z_C[regulacion_K][2]), linestyle = "--", color = Green_color)
axes[1, 0].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_C[regulacion_K][3]) + np.array(proteinas_estado_estacionario_Z_C[regulacion_K][3]), linestyle = "--", color = Blue_color)
...
axes[1, 0].set_ylim([189000, 230000])  
...
axes[1, 1].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_C[regulacion_K][0]) + np.array(proteinas_estado_estacionario_Z_C[regulacion_K][0]), linestyle = "--", color = Red_color)
axes[1, 1].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_C[regulacion_K][1]) + np.array(proteinas_estado_estacionario_Z_C[regulacion_K][1]), linestyle = "--", color = Orange_color)
axes[1, 1].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_C[regulacion_K][2]) + np.array(proteinas_estado_estacionario_Z_C[regulacion_K][2]), linestyle = "--", color = Green_color)
axes[1, 1].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_C[regulacion_K][3]) + np.array(proteinas_estado_estacionario_Z_C[regulacion_K][3]), linestyle = "--", color = Blue_color)
...
axes[1, 1].set_ylim([189000, 250000])  
axes[1, 1].axhline(y = 195000, linestyle = "--", color = "gray", label = "Hill = 0")
axes[1, 1].legend()

plt.tight_layout()
plt.savefig("Imagenes_Resultados/Costo_Metabolico_Coherente_Multiple_AND.jpg", dpi=1000)
...
plt.legend()
plt.savefig("Imagenes_Resultados/Costo_Metabolico_Incoherente_General_AND.jpg", dpi=1000)
...
axes[0, 0].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_I[regulacion_K][0]) + np.array(proteinas_estado_estacionario_Z_I[regulacion_K][0]), linestyle="--", color = Red_color)
axes[0, 0].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_I[regulacion_K][1]) + np.array(proteinas_estado_estacionario_Z_I[regulacion_K][1]), linestyle="--", color = Orange_color)
axes[0, 0].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_I[regulacion_K][2]) + np.array(proteinas_estado_estacionario_Z_I[regulacion_K][2]), linestyle="--", color = Green_color)
axes[0, 0].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_I[regulacion_K][3]) + np.array(proteinas_estado_estacionario_Z_I[regulacion_K][3]), linestyle="--", color = Blue_color)

axes[0, 0].set_title(rf'Coeficiente de Hill n = {regulacion_K+1}', fontsize = 14)
axes[0, 0].set_xlabel(r"Valor tasa $K_x$", fontsize = 14)
axes[0, 0].set_ylabel(r" $\langle Y \rangle + \langle Z \rangle$", fontsize = 14)
axes[0, 0].set_ylim([189000, 199000]) 
axes[0, 0].axhline(y = 195000, linestyle = "--", color = "gray", label = "Hill = 0")
axes[0, 0].legend() 
...
axes[0, 1].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_I[regulacion_K][0]) + np.array(proteinas_estado_estacionario_Z_I[regulacion_K][0]), linestyle="--", color = Red_color)
axes[0, 1].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_I[regulacion_K][1]) + np.array(proteinas_estado_estacionario_Z_I[regulacion_K][1]), linestyle="--", color = Orange_color)
axes[0, 1].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_I[regulacion_K][2]) + np.array(proteinas_estado_estacionario_Z_I[regulacion_K][2]), linestyle="--", color = Green_color)
axes[0, 1].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_I[regulacion_K][3]) + np.array(proteinas_estado_estacionario_Z_I[regulacion_K][3]), linestyle="--", color = Blue_color)

axes[0, 1].set_title(rf'Coeficiente de Hill n = {regulacion_K+1}', fontsize = 14)
axes[0, 1].set_xlabel(r"Valor tasa $K_x$", fontsize = 14)
axes[0, 1].set_ylabel(r" $\langle Y \rangle + \langle Z \rangle$", fontsize = 14)
axes[0, 1].set_ylim([189000, 199000])
axes[0, 1].axhline(y = 195000, linestyle = "--", color = "gray", label = "Hill = 0")  
axes[0, 1].legend()
...
axes[1, 0].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_I[regulacion_K][0]) + np.array(proteinas_estado_estacionario_Z_I[regulacion_K][0]), linestyle="--", color = Red_color)
axes[1, 0].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_I[regulacion_K][1]) + np.array(proteinas_estado_estacionario_Z_I[regulacion_K][1]), linestyle="--", color = Orange_color)
axes[1, 0].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_I[regulacion_K][2]) + np.array(proteinas_estado_estacionario_Z_I[regulacion_K][2]), linestyle="--", color = Green_color)
axes[1, 0].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_I[regulacion_K][3]) + np.array(proteinas_estado_estacionario_Z_I[regulacion_K][3]), linestyle="--", color = Blue_color)
...
axes[1, 1].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_I[regulacion_K][0]) + np.array(proteinas_estado_estacionario_Z_I[regulacion_K][0]), linestyle="--", color = Red_color)
axes[1, 1].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_I[regulacion_K][1]) + np.array(proteinas_estado_estacionario_Z_I[regulacion_K][1]), linestyle="--", color = Orange_color)
axes[1, 1].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_I[regulacion_K][2]) + np.array(proteinas_estado_estacionario_Z_I[regulacion_K][2]), linestyle="--", color = Green_color)
axes[1, 1].plot(range(1,11), np.array(proteinas_estado_estacionario_Y_I[regulacion_K][3]) + np.array(proteinas_estado_estacionario_Z_I[regulacion_K][3]), linestyle="--", color = Blue_color)
...
axes[1, 1].legend()
plt.tight_layout()
plt.savefig("Imagenes_Resultados/Costo_Metabolico_Incoherente_Multiple_AND.jpg", dpi=1000)
# %%
...
axes[1, 1].set_ylim([-0.001, 0.05]) 
axes[1, 1].legend()

plt.tight_layout()
plt.savefig("Imagenes_Resultados/Informacion_Estacionaria_Coherente_Multiple_I(X_Z|Y)_AND.jpg", dpi=1000)
...
# %% Graficas multiples de informacion incoherentes I(X;Z|Y)
...
axes[1, 1].set_xlabel(r"Valor tasa $K_x$", fontsize = 14)
axes[1, 1].set_ylabel(r"$I(\langle X \rangle; \langle Z \rangle| \langle Y \rangle)$", fontsize = 14)
axes[1, 1].set_ylim([-0.005, 0.09]) 
axes[1, 1].axhline(y = 0, linestyle = "--", color = "gray", label = "Limite \n inferior")
axes[1, 1].legend()

plt.tight_layout()
plt.savefig("Imagenes_Resultados/Informacion_Estacionaria_Incoherente_Multiple_I(X_Z|Y)_AND.jpg", dpi=1000)
