...
import pandas as pd
import json
from Logic_Gate_Function import logic_gate_function_3, Hill_Activation, Hill_Represion
...
fig.suptitle('Logic Gate 3 I4', fontsize=16)

plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.savefig("Logic_Gate_3_Incooherent_4.jpg", dpi = 500)
