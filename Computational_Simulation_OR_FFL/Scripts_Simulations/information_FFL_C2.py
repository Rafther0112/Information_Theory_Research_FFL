...
"""
Simulacion computacional con algoritmo de Gillespie del FFL C2 con compuerta logica OR
...
for Hill in valores_posibles_Hill:
    ...
    np.save('Simulacion_FFL_C2_OR_final.npy', diccionario_global_FFL_C2)
