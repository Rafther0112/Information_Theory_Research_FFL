...
#    np.save('Simulacion_FFL_C4_AND_final.npy', diccionario_global_FFL_C4)
...
fig.suptitle('Logic Gate 10 C4', fontsize=16)

plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.savefig("Logic_Gate_10_Coherent_4.jpg", dpi = 500)