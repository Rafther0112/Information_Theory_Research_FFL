...
#    np.save('Simulacion_FFL_I1_AND_final.npy', diccionario_global_FFL_I1)
...
fig.suptitle('Logic Gate 10 I1', fontsize=16)

plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.savefig("Logic_Gate_10_Icoherent_1.jpg", dpi = 500)