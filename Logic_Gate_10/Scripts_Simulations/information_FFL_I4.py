...
import pandas as pd
import json
from Logic_Gate_Function import logic_gate_function_10, Hill_Activation, Hill_Represion
...
for Hill in valores_posibles_Hill:
    ...
    for Kx in tqdm(valores_posibles_Kx):
        ...
        def funcion_creacion_ARNmZ(cantidad_X, cantidad_Y):
            ...
            retorno = logic_gate_function_10(ARNmZ_interaction_X, ARNmZ_interaction_Y, K_parameters, Ky)
...
#    np.save('Simulacion_FFL_I4_AND_final.npy', diccionario_global_FFL_I4)
...
fig.suptitle('Logic Gate 10 I4', fontsize=16)

plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.savefig("Logic_Gate_10_Icoherent_4.jpg", dpi = 500)