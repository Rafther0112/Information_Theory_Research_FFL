...
# %% CARGA DE LOS DATOS COMPUTACIONALES
...
#plt.savefig("Imagenes_Resultados/Informacion_maxima_temporal_I_XZ_C1C4_AND_color.jpg", dpi = 1000)
np.save('Resultados_Matrices_Color/Informacion_maxima_temporal_IXZ_C1C4_AND_color.npy', informacion_promedio_Maxima_Hill_C1)
#%%
...
cbar = plt.colorbar()
cbar.set_label(r'Valor de Información')
#plt.savefig("Imagenes_Resultados/Informacion_maxima_temporal_I_XZ_C2C3_AND_color.jpg", dpi = 1000)
np.save('Resultados_Matrices_Color/Informacion_maxima_temporal_IXZ_C2C3_AND_color.npy', informacion_promedio_Maxima_Hill_C2)
#%%
...
# %% GRAFICAS TEMPORAL INCOHERENTES I(X;Z)
plt.figure(figsize=(8,3))
plt.xlabel(r'Valor tasa $K_X$')
plt.ylabel(r'Coeficiente de Hill n')
...
cbar = plt.colorbar()
cbar.set_label(r'Valor de Información')
#plt.savefig("Imagenes_Resultados/Informacion_maxima_temporal_I_XZ_I1I2_AND_color.jpg", dpi = 1000)
np.save('Resultados_Matrices_Color/Informacion_maxima_temporal_I_XZ_I1I2_AND_color.npy', informacion_promedio_Maxima_Hill_I1)
#%%
...
cbar = plt.colorbar()
cbar.set_label(r'Valor de Información')
plt.savefig("Imagenes_Resultados/Informacion_maxima_temporal_I_XZ_I3I4_AND_color.jpg", dpi = 1000)
np.save('Resultados_Matrices_Color/Informacion_maxima_temporal_I_XZ_I3I4_AND_color.npy', informacion_promedio_Maxima_Hill_I3)
#%%
informacion_promedio_Maxima_Hill_I3

#%%
# %% ANALISIS TEMPORAL COHERENTES I(X;Z|Y)
tiempo_propio_X = np.arange(0,350, 10)
tiempo_propio_Y = np.arange(0,350, 10)
tiempo_propio_Z = np.arange(0,350, 10)
...
#%% GRAFICAS TEMPORALES COHERENTE I(X;Z|Y)
plt.figure(figsize=(8,3))
plt.xlabel(r'Valor tasa $K_X$')
plt.ylabel(r'Coeficiente de Hill n')
...
cbar = plt.colorbar()
cbar.set_label(r'Valor de Información')
plt.savefig("Imagenes_Resultados/Informacion_maxima_temporal_I_XZ|Y_C1C4_AND_color.jpg", dpi = 1000)
...
cbar = plt.colorbar()
cbar.set_label(r'Valor de Información')
plt.savefig("Imagenes_Resultados/Informacion_maxima_temporal_I_XZ|Y_C2C3_AND_color.jpg", dpi = 1000)

#%% ANALISIS TEMPORAL INCOHERENTES I(X;Z|Y)
tiempo_propio_X = np.arange(0,350, 10)
tiempo_propio_Y = np.arange(0,350, 10)
tiempo_propio_Z = np.arange(0,350, 10)
...
#%% GRAFICAS TEMPORALES INCOHERENTES I(X:Z|Y)
plt.figure(figsize=(8,3))
plt.xlabel(r'Valor tasa $K_X$')
plt.ylabel(r'Coeficiente de Hill n')
...
cbar = plt.colorbar()
cbar.set_label(r'Valor de Información')
plt.savefig("Imagenes_Resultados/Informacion_maxima_temporal_I_XZ|Y_I1I2_AND_color.jpg", dpi = 1000)
...
cbar = plt.colorbar()
cbar.set_label(r'Valor de Información')
plt.savefig("Imagenes_Resultados/Informacion_maxima_temporal_I_XZ|Y_I3I4_AND_color.jpg", dpi = 1000)
