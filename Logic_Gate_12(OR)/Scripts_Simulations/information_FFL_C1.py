#%%
"""
Simulacion computacional con algoritmo de Gillespie del FFL C1 con compuerta logica OR
...
for Hill in valores_posibles_Hill:
    ...
    for Kx in tqdm(valores_posibles_Kx):
        ...
        valor_Y_estacionario = Ky*(Kpy/muY)*((valor_X_estacionario**Hill)/(valor_X_estacionario**Hill + Kxy**Hill))
...
#    np.save('Simulacion_FFL_C1_OR_final.npy', diccionario_global_FFL_C1)
...
fig.suptitle('Logic Gate 12 C1', fontsize=16)

plt.tight_layout(rect=[0, 0, 1, 0.95])
#plt.savefig("Logic_Gate_12_Coherent_1.jpg", dpi = 500)
#%%