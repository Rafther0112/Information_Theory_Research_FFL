...
"""
Simulacion computacional con algoritmo de Gillespie del FFL I3 con compuerta logica OR
...
for Hill in valores_posibles_Hill:
    ...
    np.save('Simulacion_FFL_I3_OR_final.npy', diccionario_global_FFL_I3)
