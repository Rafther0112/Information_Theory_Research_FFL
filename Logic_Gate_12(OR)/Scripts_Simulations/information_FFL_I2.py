#%%
"""
Simulacion computacional con algoritmo de Gillespie del FFL I2 con compuerta logica OR
...
#    np.save('Simulacion_FFL_I2_OR_final.npy', diccionario_global_FFL_I2)
#%%
...
fig.suptitle('Logic Gate 12 I2', fontsize=16)

plt.tight_layout(rect=[0, 0, 1, 0.95])
#plt.savefig("Logic_Gate_12_Incoherent_2.jpg", dpi = 500)
#%%
