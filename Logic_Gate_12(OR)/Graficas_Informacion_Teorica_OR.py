...
for position_Hill, hill in enumerate([1,2,3,4]):
    with open(f'Theorical_Results_Information/datos_FFL_C1_Hill{hill}_OR.csv', 'r') as archivo:
    ...
    with open(f'Theorical_Results_Information/datos_FFL_C2_Hill{hill}_OR.csv', 'r') as archivo:
        lector = csv.reader(archivo)
    ...
    with open(f'Theorical_Results_Information/datos_FFL_C3_Hill{hill}_OR.csv', 'r') as archivo:
        lector = csv.reader(archivo)
    ...
    with open(f'Theorical_Results_Information/datos_FFL_C4_Hill{hill}_OR.csv', 'r') as archivo:
        lector = csv.reader(archivo)
...
for position_Hill, hill in enumerate([1,2,3,4]):
    with open(f'Theorical_Results_Information/datos_FFL_I1_Hill{hill}_OR.csv', 'r') as archivo:
        lector = csv.reader(archivo)
    ...
    with open(f'Theorical_Results_Information/datos_FFL_I2_Hill{hill}_OR.csv', 'r') as archivo:
        lector = csv.reader(archivo)
    ...
    with open(f'Theorical_Results_Information/datos_FFL_I3_Hill{hill}_OR.csv', 'r') as archivo:
        lector = csv.reader(archivo)
    ...
    with open(f'Theorical_Results_Information/datos_FFL_I4_Hill{hill}_OR.csv', 'r') as archivo:
        lector = csv.reader(archivo)
